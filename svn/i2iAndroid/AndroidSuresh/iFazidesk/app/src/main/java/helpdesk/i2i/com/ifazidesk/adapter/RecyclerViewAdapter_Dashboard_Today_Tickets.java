...
public class RecyclerViewAdapter_Dashboard_Today_Tickets extends RecyclerView.Adapter<RecyclerViewAdapter_Dashboard_Today_Tickets.ViewHolder> {
    Context context;
    ...
    public RecyclerViewAdapter_Dashboard_Today_Tickets(Context context, List<TicketdetailsItem> ticketdetailsItems, boolean SEtickets)
    {
    ...
    @Override
    public RecyclerViewAdapter_Dashboard_Today_Tickets.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
        prefs = new Preferences(context);
    ...
    @Override
    public void onBindViewHolder(RecyclerViewAdapter_Dashboard_Today_Tickets.ViewHolder viewHolder, int i) {
