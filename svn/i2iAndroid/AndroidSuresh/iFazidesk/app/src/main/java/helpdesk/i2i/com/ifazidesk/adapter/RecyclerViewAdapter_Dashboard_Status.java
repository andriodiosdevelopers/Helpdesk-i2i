...
import helpdesk.i2i.com.ifazidesk.activities.NewDashboard;
...
public class RecyclerViewAdapter_Dashboard_Status extends RecyclerView.Adapter<RecyclerViewAdapter_Dashboard_Status.ViewHolder> {
    Context context;
    ...
    public RecyclerViewAdapter_Dashboard_Status(Context context, List<StatusdetailsItem> statusdetailsItems)
    {
    ...
    @Override
    public RecyclerViewAdapter_Dashboard_Status.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
        prefs = new Preferences(context);
    ...
    @Override
    public void onBindViewHolder(RecyclerViewAdapter_Dashboard_Status.ViewHolder viewHolder, int i)
    {
...
//            Boolean isTotal = data.getJSONObject(i).getBoolean("isTotal");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view)
        {
            ...
            ((NewDashboard) context).LoadDashboardData(temp_statusid,temp_istotal);
