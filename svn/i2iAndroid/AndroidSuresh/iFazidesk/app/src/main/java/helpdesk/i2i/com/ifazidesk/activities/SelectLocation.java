...
//        try {
//            JSONArray json_array_location = new JSONArray(string_wingdetails);
//            for(int i=0;i<json_array_location.length();i++)
//            {
//                int FloorId = json_array_location.getJSONObject(i).getInt("FloorId");
//                int WingID = json_array_location.getJSONObject(i).getInt("WingID");
//                String Wing = json_array_location.getJSONObject(i).getString("Wing");
//                if(FloorId == Integer.parseInt(string_floorid))
//                {
//                    SetWing(Wing, ""+WingID);
//                }
