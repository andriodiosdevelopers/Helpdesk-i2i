...
public class ListViewAdapter_Location extends BaseAdapter {
    ...
    public ListViewAdapter_Location(Context context,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        tv_name.setText(resultp.get(Fragment_List_Location.List_Item_Name));
        tv_id.setText(resultp.get(Fragment_List_Location.List_Item_ID));
