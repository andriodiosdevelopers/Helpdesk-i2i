...
public class TicketDetailsData {
	...
	private List<TicketHistoryItem> lsthistory;
	...
	public void setLsthistory(List<TicketHistoryItem> lsthistory){
		this.lsthistory = lsthistory;
	}

	public List<TicketHistoryItem> getLsthistory(){
		return lsthistory;
	}
