...
public class RecyclerViewAdapter_Dashboard_Week_Tickets extends RecyclerView.Adapter<RecyclerViewAdapter_Dashboard_Week_Tickets.ViewHolder> {
    Context context;
    ...
    int int_statusid = 0;
    public RecyclerViewAdapter_Dashboard_Week_Tickets(Context context, List<TicketdetailsItem> TicketdetailsItem)
    //public RecyclerViewAdapter_Dashboard_Week_Tickets(Context context, JSONArray jsonArray)
    {
    ...
    @Override
    public RecyclerViewAdapter_Dashboard_Week_Tickets.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
        prefs = new Preferences(context);
    ...
    @Override
    public void onBindViewHolder(RecyclerViewAdapter_Dashboard_Week_Tickets.ViewHolder viewHolder, int i) {
