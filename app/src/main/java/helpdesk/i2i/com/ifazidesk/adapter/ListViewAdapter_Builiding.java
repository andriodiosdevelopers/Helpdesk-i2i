...
public class ListViewAdapter_Builiding extends BaseAdapter {
    ...
    public ListViewAdapter_Builiding(Context context,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        tv_name.setText(resultp.get(Fragment_List_Building.List_Item_Name));
        tv_id.setText(resultp.get(Fragment_List_Building.List_Item_ID));
