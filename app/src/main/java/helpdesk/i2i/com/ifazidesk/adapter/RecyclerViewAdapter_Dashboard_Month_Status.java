...
public class RecyclerViewAdapter_Dashboard_Month_Status extends RecyclerView.Adapter<RecyclerViewAdapter_Dashboard_Month_Status.ViewHolder> {
    Context context;
    ...
    String status_color;
    int statusid = 0;
    //public RecyclerViewAdapter_Dashboard_Month_Status(Context context, JSONArray jsonArray)
    public RecyclerViewAdapter_Dashboard_Month_Status(Context context, List<StatusdetailsItem> StatusdetailsItem)
    {
    ...
    @Override
    public RecyclerViewAdapter_Dashboard_Month_Status.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
        prefs = new Preferences(context);
    ...
    @Override
    public void onBindViewHolder(RecyclerViewAdapter_Dashboard_Month_Status.ViewHolder viewHolder, int i)
    {
...
//            Boolean isTotal = data.getJSONObject(i).getBoolean("isTotal");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view)
        {
            ...
            ((DashboardNew) context).LoadDashboardData_Month(temp_statusid,temp_istotal);
