...
public class RecyclerViewAdapter_Dashboard_Month_Tickets extends RecyclerView.Adapter<RecyclerViewAdapter_Dashboard_Month_Tickets.ViewHolder> {
    Context context;
    ...
    int int_statusid = 0;
    //public RecyclerViewAdapter_Dashboard_Month_Tickets(Context context, JSONArray jsonArray)
    public RecyclerViewAdapter_Dashboard_Month_Tickets(Context context, List<TicketdetailsItem> TicketdetailsItem)
    {
    ...
    @Override
    public RecyclerViewAdapter_Dashboard_Month_Tickets.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
        prefs = new Preferences(context);
    ...
    @Override
    public void onBindViewHolder(RecyclerViewAdapter_Dashboard_Month_Tickets.ViewHolder viewHolder, int i) {
        ...
        try {
                ...
                Boolean IsOnHold = data_ticketdetailsitem.get(i).isIsonHold();
