...
public class ListViewAdapter_Wing extends BaseAdapter {
    ...
    public ListViewAdapter_Wing(Context context,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        tv_name.setText(resultp.get(Fragment_List_Wing.List_Item_Name));
        tv_id.setText(resultp.get(Fragment_List_Wing.List_Item_ID));
