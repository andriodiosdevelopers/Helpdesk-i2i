...
public class NetworkCall_MultiLanguage {
    String SOAPNameSpace = "http://tempuri.org/";
    String SOAPUrl = "http://ifazility.com/appcontrols/appcontrolservices.asmx";
    int networkTimeOut = 90 * 1000;// 90 seconds
    Context mContext;

    public NetworkCall_MultiLanguage(Context context) {
        mContext = context;
    }
